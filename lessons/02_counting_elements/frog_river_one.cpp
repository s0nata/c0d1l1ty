 ...
 * Result: https://codility.com/demo/results/demoCYVF2H-J7M/
 *
 * A small frog wants to get to the other side of a river. The frog is
 * currently located at position 0, and wants to get to position
 * X. Leaves fall from a tree onto the surface of the river.
 *
 ...
 * position where one leaf falls at time K, measured in minutes.
 *
 ...
 * A[7] = 4
 *
 * In minute 6, a leaf falls into position 5. This is the earliest time
 ...
 * integers and integer X, returns the earliest time when the frog can
