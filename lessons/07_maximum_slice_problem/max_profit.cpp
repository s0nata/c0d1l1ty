 ...
 * Result: 100/100 @ https://codility.com/demo/results/demo7XE89M-FFE/
 *
 * A zero-indexed array A consisting of N integers is given. It contains
 * daily prices of a stock share for a period of N consecutive days. If
 * a single share was bought on day P and sold on day Q, where 0 ≤ P ≤ Q
 ...
 * was 356. It would occur if a share was bought on day 1 and sold on
 * day 5.
 *
 * Write a function,
 *
 ...
 * consecutive days, returns the maximum possible profit from one
 * transaction during this period. The function should return 0 if it
 * was impossible to gain any profit.
 *
