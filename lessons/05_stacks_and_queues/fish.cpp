 ...
 * Result: 100/100 @ https://codility.com/demo/results/demo94SEB2-KQ9/
 *
 * You are given two non-empty zero-indexed arrays A and B consisting
 * of N integers. Arrays A and B represent N voracious fish in a
 ...
 * (living) fish between them, they will eventually meet each
 ...
 * other when P < Q, B[P] = 1 and B[Q] = 0, and there are no living
 ...
 * number 4 and is eaten by it. The remaining two fish, number 0 and
 ...
 *
 * that, given two non-empty zero-indexed arrays A and B consisting of
