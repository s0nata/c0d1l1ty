 ...
 * Result: 100/100 @ https://codility.com/demo/results/demoF4FKJE-3NA/
 *
 * A non-empty zero-indexed array A consisting of N integers is
 * given. The product of triplet (P, Q, R) equates to 
 ...
 *
 * that, given a non-empty zero-indexed array A, returns the 
 ...
 * A[5] = 6
 *
 * the function should return 60, as the product of triplet
 * (2, 4, 5) is maximal.
 *
 * Assume that:
 *
